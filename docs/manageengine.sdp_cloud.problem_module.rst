...
.. _ansible_collections.manageengine.sdp_cloud.problem_module:

.. Anchors: short name for ansible.builtin

.. Title

manageengine.sdp_cloud.problem module -- Manage problems in ManageEngine ServiceDesk Plus Cloud
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`manageengine.sdp_cloud.problem`.
...
- When :literal:`state=present` (default) and :literal:`problem\_id` is omitted, creates a new problem. The :literal:`title` option is mandatory for create operations.
- When :literal:`state=present` and :literal:`problem\_id` is set, updates the existing problem. Supports idempotency — skips the API call if no changes are detected.
- When :literal:`state=absent`\ , deletes the problem identified by :literal:`problem\_id`.
- Supports check mode and diff mode.
- See \ `https://www.manageengine.com/products/service\-desk/sdpod\-v3\-api/problems/problem.html <https://www.manageengine.com/products/service-desk/sdpod-v3-api/problems/problem.html>`__ for full API details.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-auth_token:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-client_id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-client_secret:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-dc:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-domain:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-payload:
    ...
    - .. raw:: html
      ...
      Supported fields include :literal:`description`\ , :literal:`impact\_details`\ , :literal:`priority`\ , :literal:`urgency`\ , :literal:`impact`\ , :literal:`status`\ , :literal:`template`\ , :literal:`category`\ , :literal:`subcategory`\ , :literal:`item`\ , :literal:`site`\ , :literal:`group`\ , :literal:`requester`\ , :literal:`technician`\ , :literal:`reported\_by`\ , :literal:`due\_by\_time`\ , :literal:`reported\_time`\ , :literal:`closed\_time`\ , and grouped fields (\ :literal:`impact\_details\_description`\ , :literal:`root\_cause\_description`\ , :literal:`symptoms\_description`\ , :literal:`known\_error\_comments`\ , :literal:`is\_known\_error`\ , :literal:`close\_details\_comments`\ , :literal:`closure\_code`\ , :literal:`resolution\_details\_description`\ , :literal:`workaround\_details\_description`\ ).
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-portal_name:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-problem_id"></div>

      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-problem_id:
      ...
      **problem_id**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-problem_id" title="Permalink to this option"></a>
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-refresh_token:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-state:
    ...
    - .. raw:: html
      ...
      :literal:`present` ensures the problem exists (create or update).

      :literal:`absent` ensures the problem is deleted.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__parameter-title:
    ...
    - .. raw:: html
      ...
      :strong:`Mandatory` when creating a new problem (\ :literal:`state=present` without :literal:`problem\_id`\ ).
...
.. list-table::
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="return-problem"></div>

      .. _ansible_collections.manageengine.sdp_cloud.problem_module__return-problem:
      ...
      **problem**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#return-problem" title="Permalink to this return value"></a>
    ...
    - .. raw:: html
      ...
      The problem record from the API response.
      ...
      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"created\_time": {"display\_value": "Nov 10, 2025 10:00 AM", "value": "1731234000000"}, "group": {"id": "100000000000004", "name": "Infrastructure"}, "id": "234567890123456", "priority": {"id": "100000000000002", "name": "High"}, "status": {"id": "100000000000001", "name": "Open"}, "title": "Server connectivity issues in DC\-2"}`
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="return-problem_id"></div>

      .. _ansible_collections.manageengine.sdp_cloud.problem_module__return-problem_id:
      ...
      **problem_id**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#return-problem_id" title="Permalink to this return value"></a>
    ...
    - .. raw:: html
      ...
      The ID of the created, updated, or deleted problem.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_module__return-response:
