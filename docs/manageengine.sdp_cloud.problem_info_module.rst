...
.. _ansible_collections.manageengine.sdp_cloud.problem_info_module:

.. Anchors: short name for ansible.builtin

.. Title

manageengine.sdp_cloud.problem_info module -- Retrieve problem records from ManageEngine ServiceDesk Plus Cloud
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`manageengine.sdp_cloud.problem_info`.
...
- If :literal:`problem\_id` is provided, retrieves a single problem by ID.
- If :literal:`problem\_id` is omitted, retrieves a list of problems with optional pagination and sorting.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-auth_token:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-client_id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-client_secret:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-dc:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-domain:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-get_total_count:
    ...
    - .. raw:: html
      ...
      Ignored when :literal:`problem\_id` is provided.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-portal_name:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-problem_id:
    ...
    - .. raw:: html
      ...
      When provided, performs a :literal:`GET /api/v3/problems/{id}` call and returns the single problem.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-refresh_token:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-row_count:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-sort_field:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-sort_order:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__parameter-start_index:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__return-problem:
    ...
    - .. raw:: html
      ...
      The single problem record (when problem\_id is provided).


      .. rst-class:: ansible-option-line

      :ansible-option-returned-bold:`Returned:` when problem\_id is provided

      .. rst-class:: ansible-option-line
      .. rst-class:: ansible-option-sample

      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"id": "234567890123456", "priority": {"id": "100000000000002", "name": "High"}, "status": {"id": "100000000000001", "name": "Open"}, "title": "Server connectivity issues in DC\-2"}`
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="return-problems"></div>

      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__return-problems:
      ...
      **problems**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#return-problems" title="Permalink to this return value"></a>
    ...
    - .. raw:: html
      ...
      List of problem records (when listing).


      .. rst-class:: ansible-option-line

      :ansible-option-returned-bold:`Returned:` when problem\_id is omitted

      .. rst-class:: ansible-option-line
      .. rst-class:: ansible-option-sample

      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`[{"id": "234567890123456", "status": {"id": "100000000000001", "name": "Open"}, "title": "Server connectivity issues in DC\-2"}]`
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.problem_info_module__return-response:
