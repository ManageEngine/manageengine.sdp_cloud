...
.. _ansible_collections.manageengine.sdp_cloud.change_info_module:

.. Anchors: short name for ansible.builtin

.. Title

manageengine.sdp_cloud.change_info module -- Retrieve change records from ManageEngine ServiceDesk Plus Cloud
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`manageengine.sdp_cloud.change_info`.
...
- If :literal:`change\_id` is provided, retrieves a single change by ID.
- If :literal:`change\_id` is omitted, retrieves a list of changes with optional pagination and sorting.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-auth_token:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-change_id:
    ...
    - .. raw:: html
      ...
      When provided, performs a :literal:`GET /api/v3/changes/{id}` call and returns the single change.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-client_id:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-client_secret:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-dc:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-domain:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-get_total_count:
    ...
    - .. raw:: html
      ...
      Ignored when :literal:`change\_id` is provided.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-portal_name:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-refresh_token:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-row_count:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-sort_field:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-sort_order:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__parameter-start_index:
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__return-change:
    ...
    - .. raw:: html
      ...
      The single change record (when change\_id is provided).


      .. rst-class:: ansible-option-line

      :ansible-option-returned-bold:`Returned:` when change\_id is provided

      .. rst-class:: ansible-option-line
      .. rst-class:: ansible-option-sample

      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`{"id": "234567890123456", "priority": {"id": "100000000000002", "name": "High"}, "status": {"id": "100000000000001", "name": "Requested"}, "title": "Upgrade database server"}`
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__return-changes:
    ...
    - .. raw:: html
      ...
      List of change records (when listing).


      .. rst-class:: ansible-option-line

      :ansible-option-returned-bold:`Returned:` when change\_id is omitted

      .. rst-class:: ansible-option-line
      .. rst-class:: ansible-option-sample

      :ansible-option-sample-bold:`Sample:` :ansible-rv-sample-value:`[{"id": "234567890123456", "status": {"id": "100000000000001", "name": "Requested"}, "title": "Upgrade database server"}]`
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.manageengine.sdp_cloud.change_info_module__return-response:
